...
webix.protoUI({
	...
	$skin:function(){
		if(webix.skin.$active.customCheckbox)
			this.defaults.customCheckbox = "<a onclick='void(0)'><label class='webix_custom_checkbox'></label></a>";
	}
}, webix.ui.text);
...
webix.protoUI({
	...
	$skin:function(){
		if(webix.skin.$active.customRadio)
			this.defaults.customRadio = "<a onclick='void(0)'><label class='webix_custom_radio'></label></a>";
